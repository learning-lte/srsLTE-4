...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.file2 = file2 = "/home/ite367/Documents/traffic_data/wifi/"+"Home_CH"+str(center_fre_ch2)+"at"+str(datetime.datetime.now().hour)+str(datetime.datetime.now().minute)+".txt"
        self.file1 = file1 = "/home/ite367/Documents/traffic_data/wifi/"+"Home_CH"+str(center_fre)+"at"+str(datetime.datetime.now().hour)+str(datetime.datetime.now().minute)+".txt"
